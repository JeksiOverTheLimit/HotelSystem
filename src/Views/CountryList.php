                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            ...
                                            <li><a class='dropdown-item' href="../Controllers/CountryPageController.php?Edit&editId=<?php echo $country->getId(); ?>">Edit</a></li>
                                        </ul>
                                    </div>
                                    <div id='overlay'></div>
...
<script>
    function showDeletePopup(countryId) {
        ...
        deleteForm.action = "../Controllers/CountryPageController.php?deleteId=" + countryId;
    }
