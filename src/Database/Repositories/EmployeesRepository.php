...
class EmployeesRepository
{
    ...
    public function create(string $firstName, string $lastName, string $egn, string $phoneNumber, int $countryId, int $cityId): Employees
    {
    ...
    public function findById(?int $id): ?Employees
    {
        ...
        $employee = $statement->fetchObject(Employees::class) ?: null;
