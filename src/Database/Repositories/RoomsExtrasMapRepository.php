...
class RoomsExtrasMapRepository
{
    ...
    public function create(int $roomId, int $extraId): RoomExtrasMap
    {
    ...
    public function findById(?int $id): ?RoomExtrasMap
    {
        ...
        $guests = $statement->fetchObject(RoomExtrasMap::class) ?: null;

        return $guests;
    }

    public function findByRoomId(int $roomId): ?RoomExtrasMap
    {
    ...
    public function getAllRoomsExtrasMap() : ?RoomExtrasMap
    {
        ...
        $result = $statement->fetchObject(RoomExtrasMap::class) ?: null;
